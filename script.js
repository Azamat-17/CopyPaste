...
const translations = {
  ky: {
    ...
    hero_sub: 'Ксерокопия, басып чыгаруу, тиктирүү жана ламинирлөө. Күн сайын иштейбиз, келиңиз же документиңизди жөнөтүңүз, чыгарып даярдап коёбуз.',
  ...
  ru: {
    ...
    hero_sub: 'Ксерокопия, печать, переплёт и ламинирование. Работаем каждый день, приходите или отправьте документ — распечатаем и подготовим.',
